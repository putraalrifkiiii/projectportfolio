...
const Navbar = () => {
  ...
  return (
    <div className="Navbar py-7 flex items-center justify-between ">
      ...
      <ul
        className={` flex items-center gap-6 md:gap-10 fixed md:static left-1/2 md:left-0 -translate-x-1/2 md:translate-x-0 opacity-100 rounded-br-2xl rounded-bl-2xl p-4 transition-all backdrop-blur-md bg-green-600/30 md:bg-transparent animate__animated animate__backInRight animate__delay-2s ${active ? "top-0 opacity-100" : "-top-15 opacity-0"}`}
      >
        <li>
